...
public class frmVistaCliente extends javax.swing.JFrame {
    ...
    public frmVistaCliente() throws SQLException {
        initComponents();
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        frmVenta.txtidcliente.setText(idcliente);
        this.dispose();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(frmVistaCliente.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
